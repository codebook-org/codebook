    ...
    <main className="min-h-[calc(100vh-4rem)] flex flex-col justify-center max-w-2xl mx-auto px-6 py-16 text-left">
      <section className="mb-8">
        ...
        <p className="text-sm opacity-80 leading-relaxed">
          codebook is a collaborative coding platform designed to make technical
          interview prep and practice interactive. unlike other traditional,
          solo-grind platforms, codebook lets you take the wheel, letting you
          create and publish your own problems.
        </p>
      </section>
