  ...
  return (
    <main className="min-h-[calc(100vh-4rem)] flex flex-col justify-center max-w-3xl mx-auto py-6 text-left">
      <header className="font-mono px-6 py-2 mb-5">
        <h1 className="text-xl font-bold text-monaco-txt">codebook<span className="animate-blink">_</span></h1>
      ...
      <section className="font-mono px-6 py-2 mb-5 backdrop-blur-sm">
        ...
        <p className="text-sm text-monaco-txt leading-relaxed mt-4">
          Create custom problems using codebook's feature-rich problem editor and publish them directly
          to your profile to grow your very own repository of programming challenges.
        </p>
        <p className="text-sm text-monaco-txt leading-relaxed mt-4">
